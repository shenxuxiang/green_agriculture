...
interface HomeServiceApi {
    ...
    fun queryBannerList(@Body body: JsonObject): Call<ResponseData<List<SwiperWidgetItemOption>>>

    @POST("v1.0/policyInformation/page")
    fun queryPolicyInformationList(@Body body: JsonObject): Call<ResponseData<PaginationData<List<PolicyInformationItemOption>>>>
}