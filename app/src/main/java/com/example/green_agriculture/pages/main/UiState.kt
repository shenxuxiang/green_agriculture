...
private val mainNavList = mainViewPagerList.map {
...
data class UiState(
    ...
    val tabList: List<TabNavigationItemOption> = mainNavList,
    val viewPagerList: List<BottomNavigationItem> = mainViewPagerList,
)